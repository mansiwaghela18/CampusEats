...
public class Floor4DashboardActivity extends AppCompatActivity {

    private static final String TAG = "Floor4Dashboard";
    ...
    private String[] optionNames = {"Floor 4"};
    ...
    private static final String FLOOR_NAME = "Floor 4";
    private static final String FLOOR_DESCRIPTION = "Main Cafe";
    private static final String FLOOR_EMAIL = "floor4@gmail.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.activity_floor4_dashboard);
    ...
    private void handleOptionClick(String optionName) {
        ...
        try {
            ...
            switch (optionName.trim()) {
                case "Floor 4":
                    // Navigate to Floor 4 Menu Management
