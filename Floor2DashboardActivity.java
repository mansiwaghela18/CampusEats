...
public class Floor2DashboardActivity extends AppCompatActivity {

    private static final String TAG = "Floor2Dashboard";
    ...
    private String[] optionNames = {"Floor 2"};
    ...
    private static final String FLOOR_NAME = "Floor 2";
    private static final String FLOOR_DESCRIPTION = "Main Cafe";
    private static final String FLOOR_EMAIL = "floor2@gmail.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.activity_floor2_dashboard);
    ...
    private void handleOptionClick(String optionName) {
        ...
        try {
            ...
            switch (optionName.trim()) {
                case "Floor 2":
                    // Navigate to Floor 2 Menu Management
