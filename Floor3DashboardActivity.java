...
public class Floor3DashboardActivity extends AppCompatActivity {

    private static final String TAG = "Floor3Dashboard";
    ...
    private String[] optionNames = {"Floor 3"};
    ...
    private static final String FLOOR_NAME = "Floor 3";
    private static final String FLOOR_DESCRIPTION = "Main Cafe";
    private static final String FLOOR_EMAIL = "floor3@gmail.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.activity_floor3_dashboard);
    ...
    private void handleOptionClick(String optionName) {
        ...
        try {
            ...
            switch (optionName.trim()) {
                case "Floor 3":
                    // Navigate to Floor 3 Menu Management
